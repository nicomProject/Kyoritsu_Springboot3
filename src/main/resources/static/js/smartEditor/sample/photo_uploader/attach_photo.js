    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        // aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button'+nImageFileCount+'" src="./img/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');
    ...
    function html5Upload() {
    	...
    	sUploadURL= '/api/smarteditorMultiImageUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/api/singleImageUploader',	//샘플 URL입니다.
